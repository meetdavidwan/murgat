...
# --- Configuration ---
if len(sys.argv) < 3:
    print("Usage: python run_baseline_with_citation.py <dataset_name> <model_name>")
    sys.exit(1)
...
REASONING_PROMPT_PATH = "prompts/base_with_citations.txt"
model_name_str = MODEL_NAME.replace("-", "_")
OUTPUT_DIR = f"outputs/{DATA}_{model_name_str}_baseline_with_citations.json"
MAX_NUM = 100
